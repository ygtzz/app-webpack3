<template>
    <div class="home">
        ...
        <div class="panel fast">
            ...
            <div class="body">
                <div ref="fastWrapper" class="fast-wrap">
                    <ul class="fast-list">
                        <li class="fast-item" v-for="item in model.fastData.data" :key="'fast'+item.name">
        ...
        <div v-for="(item,index) in model.oldData.data" class="panel choice" :key="'olddata'+index">
            <div class="header">
